...
import profile from './../images/claus.jpg';
		...
		<>
			<Jumbotron jumbotron-fluid="true" style={{ backgroundImage: `url(${background_camera})`, backgroundSize: 'cover' }}>
				<div className="text-container">
					...
					<p>For oss er det viktig med personligoppfølging av våre kunder og vi tilbyr produksjoner til gode priser. Vi kan love at vi sammen kommer fram til gode løsninger skreddersydd ditt behov.</p>
				</div>
			</Jumbotron>
			...
			<div className="testimonail-container">
				...
				<p>Stig Eriksen, avdelingsleder Digital Læring, Avonova</p>
			</div>
		</>
	);
}